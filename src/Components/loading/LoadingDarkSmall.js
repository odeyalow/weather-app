const LoadingDark = (width) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" width="100" height="67" style={{ shapeRendering: "auto", display: "block", background: "transparent", backgroundColor:'#fff', borderRadius:'20px', width:'150px'}} xmlnsXlink="http://www.w3.org/1999/xlink">
            <g>
